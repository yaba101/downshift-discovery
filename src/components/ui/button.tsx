...
const buttonVariants = cva(
  'inline-flex h-11 items-center justify-center gap-2 rounded-md px-4 text-sm font-bold transition focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-cobalt disabled:pointer-events-none disabled:opacity-50',
  {
    variants: {
      variant: {
        default: 'bg-olive text-white shadow-sm hover:bg-olive/90',
        outline: 'border border-line bg-white text-olive hover:border-olive hover:text-olive',
        ghost: 'text-olive hover:bg-white/70',
        soft: 'bg-sage-button text-olive hover:bg-sage-button/80',
      },
      size: {
        default: 'h-11 px-4',
        sm: 'h-9 px-3 text-xs',
